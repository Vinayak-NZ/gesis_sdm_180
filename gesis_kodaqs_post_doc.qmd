...
## A quick overview {background="#FFFFFF"}

-   Official Statistics <br> <br>
-   Career Break <br> <br>
-   Academia <br> <br>

## My work experience {background="#FFFFFF"}

-   Championing Data Quality <br> <br>
-   Advising on Methodology <br> <br>
-   Innovating with Training <br> <br>
-   Leading through collaboration

## What I value? {background="#FFFFFF"}
...
| Process evaluation | Co-creator experience, Facilitator reflection |
:::
...
| Features of AI tool that are important | Execution, Control, Model Type, Quality metrics, Interpretability | Dot Voting |
...
| **3. Infrastructure** | • Implementation environment (local R/Python, online app, server, cloud, hybrid)<br>• Compute requirements<br>• Data security & privacy considerations |
